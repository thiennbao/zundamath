...
<template>
  <div :class="{ 'w-72': isOpen, 'w-0': !isOpen }">
    <div
      :class="{ 'w-72 px-4': isOpen, 'w-0 px-0': !isOpen }"
      class="fixed h-screen py-4 bg-[#101010] transition-all overflow-y-scroll [&::-webkit-scrollbar]:w-[2px] [&::-webkit-scrollbar-thumb]:bg-primary"
    >
